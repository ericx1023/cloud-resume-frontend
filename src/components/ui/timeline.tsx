...
export const Timeline = ({ 
  ...
  return (
    <div
      className="w-full bg-gray-50 font-sans md:px-10 pt-[60vh] mt-[0vh]"
      ref={containerRef}
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2 className="text-lg md:text-4xl mb-4 text-gray-800 max-w-4xl font-bold">
          {title}
        </h2>
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        {data.map((item, index) => (
          <div
            key={index}
            className="flex justify-start pt-10 md:pt-40 md:gap-12 lg:gap-16"
          >
            ...
            <div className="relative pl-20 pr-4 md:pl-8 md:pr-8 w-full md:w-2/3 max-w-4xl">
