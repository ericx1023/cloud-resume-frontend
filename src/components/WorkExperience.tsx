    ...
    >
      <div className="grid md:grid-cols-3 gap-8 w-full max-w-5xl mx-auto px-4 absolute top-1/2 -translate-y-1/2">
        <div className="md:col-span-2">
          <h2 className="text-2xl font-bold text-gray-800 mb-4 font-montserrat">Work Experience</h2>
          <div className="space-y-6 font-merriweather">
            <div>
              <h3 className="text-xl font-semibold text-gray-800 font-montserrat">Software Development Manager</h3>
              <p className="text-blue-600 font-medium">Fortinet, Inc. | Feb 2022 - Present</p>
              <p className="text-gray-500 italic mb-2 font-roboto-slab">Tech stack: React, Angular, TypeScript, Rx.js, Next.js, Docker, Web Component</p>
            ...
            <div>
              <h3 className="text-xl font-semibold text-gray-800 font-montserrat">Senior Software Development Engineer</h3>
              <p className="text-blue-600 font-medium">Fortinet, Inc. Taiwan | Aug 2017 - Feb 2022</p>
              <p className="text-gray-500 italic mb-2 font-roboto-slab">Tech stack: Stage.js, Backbone.js, Git, Redux, Tailwind CSS, Python, Node.js, PostgreSQL</p>
              <ul className="mt-2 list-disc list-inside text-gray-600 space-y-1">
            ...
            <div>
              <h3 className="text-xl font-semibold text-gray-800 font-montserrat">Frontend Web Developer</h3>
              <p className="text-blue-600 font-medium">Jumbo Technology Corp | Jan 2015 - Aug 2017</p>
              <p className="text-gray-500 italic mb-2 font-roboto-slab">Tech stack: Javascript, JQuery, HTML, CSS, SVN</p>
              <ul className="mt-2 list-disc list-inside text-gray-600 space-y-1">
        ...
        <div>
          <h2 className="text-2xl font-bold text-gray-800 mb-4 font-montserrat">Education</h2>
